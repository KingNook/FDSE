...
model = NonhydrostaticModel(; grid,
            ...
            timestepper = :RungeKutta3, # Set the timestepping scheme, here 3rd order Runge-Kutta
               ...
               buoyancy = Buoyancy(model=BuoyancyTracer(), gravity_unit_vector=g), # this tells the model that b will act as the buoyancy (and influence momentum) 
